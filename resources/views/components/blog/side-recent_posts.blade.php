...
<div class="side">
    ...
    @foreach($recent_posts as $recent_posts)
        <div class="f-blog">
            <a href="{{ route('posts.show', $recent_posts) }}" class="blog-img" style="background-image: url('{{ optional($recent_posts->image)->url ?? asset('storage/placeholders/placeholder-image.png') }}');"></a>
            <div class="desc">
